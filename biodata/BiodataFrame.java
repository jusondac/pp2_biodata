...
public class BiodataFrame extends JFrame {
    ...
    public BiodataFrame() {
        ...
        for (Biodata annj: this.biodataList) {
            System.out.println(annj.getNama() +" "+annj.getAlamat()+" "+annj.getNo_telp()+" "+annj.getJenis_kelamin());
        }
    ...
    public String getNoTelp() { return textnomor.getText(); }
